...
function PaymentPieSuccessContent() {
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-700 ring-1 ring-white/20">
                        ...
                        <div className="bg-[#36595F] px-8 py-10 text-center relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">¡Pie Pagado Exitosamente!</h1>
                                <p className="text-white/80">Tu pago inicial ha sido procesado correctamente.</p>
                            </div>
                        </div>
...
export default function PaymentPieSuccessPage() {
    return (
